...
TOKEN = os.getenv('BOT_TOKEN', '8924716382:AAEwSTDZ7uipfNGypnj2v8yZGshY_1tvfyI')
...
if __name__ == '__main__':
    ...
    # 1. Запуск мини веб-сервера в отдельном потоке (для обхода Port Binding в Web Service)
    web_thread = threading.Thread(target=run_web_server, daemon=True)
    web_thread.start()

    # 2. Запуск фоновой рассылки
